export default SavedText =[
    {
        ...
        id:1,
        title:'Regular Cake',
        caption:'enjoy a delicious easy to make home made cake in just 30 minutes',
        photo: require('../Images/Cake.jpg')
    },
    {

        id:2,
        title:'Pan Cakes',
        caption:'step up your breakfast with these delicious pancakes',
        photo: require('../Images/PanCake.jpg')
    ...
    },
    {
        ...
        id:3,
        title:'Cheese Cake',
        caption:'nothing brings people together like Cheesecakes!!',
